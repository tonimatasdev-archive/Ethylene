...
import org.bukkit.craftbukkit.v1_20_R5.entity.CraftEntityTypes;
...
import org.bukkit.craftbukkit.v1_20_R5.util.BlockStateListPopulator;
import org.bukkit.craftbukkit.v1_20_R5.util.CraftLocation;
import org.bukkit.craftbukkit.v1_20_R5.util.RandomSourceWrapper;
...
public abstract class CraftRegionAccessor implements RegionAccessor {
    ...
    public <T extends Entity> T addEntity(net.minecraft.world.entity.Entity entity, CreatureSpawnEvent.SpawnReason reason, Consumer<? super T> function, boolean randomizeData) throws IllegalArgumentException {
        ...
        if (randomizeData && entity instanceof net.minecraft.world.entity.Mob) {
            ((net.minecraft.world.entity.Mob) entity).finalizeSpawn(getHandle(), getHandle().getCurrentDifficultyAt(entity.blockPosition()), MobSpawnType.COMMAND, (SpawnGroupData) null);
        }
