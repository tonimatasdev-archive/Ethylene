...
import org.bukkit.craftbukkit.v1_20_R5.util.CraftNBTTagConfigSerializer;
import org.bukkit.craftbukkit.v1_20_R5.CraftEquipmentSlot;
import org.bukkit.craftbukkit.v1_20_R5.CraftRegistry;
import org.bukkit.craftbukkit.v1_20_R5.Overridden;
...
import org.bukkit.craftbukkit.v1_20_R5.enchantments.CraftEnchantment;
import org.bukkit.craftbukkit.v1_20_R5.inventory.CraftMetaItem.ItemMetaKey.Specific;
import org.bukkit.craftbukkit.v1_20_R5.inventory.components.CraftFoodComponent;
import org.bukkit.craftbukkit.v1_20_R5.inventory.components.CraftToolComponent;
import org.bukkit.craftbukkit.v1_20_R5.inventory.tags.DeprecatedCustomTagContainer;
import org.bukkit.craftbukkit.v1_20_R5.persistence.CraftPersistentDataContainer;
import org.bukkit.craftbukkit.v1_20_R5.persistence.CraftPersistentDataTypeRegistry;
...
class CraftMetaItem implements ItemMeta, Damageable, Repairable, BlockDataMeta {
    ...
    CraftMetaItem(DataComponentPatch tag) {
        ...
        getOrEmpty(tag, CUSTOM_DATA).ifPresent((customData) -> {
            ...
            if (customTag.contains(BUKKIT_CUSTOM_TAG.NBT)) {
                CompoundTag compound = customTag.getCompound(BUKKIT_CUSTOM_TAG.NBT);
    ...
    CraftMetaItem(Map<String, Object> map) {
        ...
        if (unhandled != null) {
            ...
            try {
                ...
                unhandledTags.copy(DataComponentPatch.CODEC.parse(MinecraftServer.getDefaultRegistryAccess().createSerializationContext(NbtOps.INSTANCE), unhandledTag).result().get());
            } catch (IOException ex) {
                Logger.getLogger(CraftMetaItem.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    ImmutableMap.Builder<String, Object> serialize(ImmutableMap.Builder<String, Object> builder) {
        ...
        if (!unhandledTags.isEmpty()) {
            Tag unhandled = DataComponentPatch.CODEC.encodeStart(MinecraftServer.getDefaultRegistryAccess().createSerializationContext(NbtOps.INSTANCE), unhandledTags.build()).getOrThrow(IllegalStateException::new);
            try {
                ByteArrayOutputStream buf = new ByteArrayOutputStream();
