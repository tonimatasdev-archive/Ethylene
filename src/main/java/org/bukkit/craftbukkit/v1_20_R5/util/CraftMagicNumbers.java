...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    public ItemStack modifyItemStack(ItemStack stack, String arguments) {
        ...
        try {
            nmsStack.applyComponents(new TagParser(Commands.createValidationContext(MinecraftServer.getDefaultRegistryAccess())).parse(new StringReader(arguments)).components());
