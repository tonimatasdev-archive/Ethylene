...
public class TransformerGeneratorAccess extends DelegatedGeneratorAccess {
    ...
    @Override
    public boolean setBlock(BlockPos position, net.minecraft.world.level.block.state.BlockState iblockdata, int i, int j) {
    ...
    @Override
    public boolean setBlock(BlockPos position, net.minecraft.world.level.block.state.BlockState iblockdata, int i) {
