...
import org.bukkit.craftbukkit.v1_20_R5.generator.CraftLimitedRegion;
...
public class CraftStructureTransformer {
    ...
    public CraftStructureTransformer(Cause cause, WorldGenLevel generatoraccessseed, StructureManager structuremanager, Structure structure, BoundingBox structureboundingbox, ChunkPos ChunkPos) {
        ...
        this.limitedRegion = new CraftLimitedRegion(generatoraccessseed, ChunkPos);
    }

    public CraftStructureTransformer(WorldGenLevel generatoraccessseed, ChunkPos ChunkPos, Collection<BlockTransformer> blockTransformers, Collection<EntityTransformer> entityTransformers) {
