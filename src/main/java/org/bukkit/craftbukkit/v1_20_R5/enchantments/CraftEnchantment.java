package org.bukkit.craftbukkit.v1_20_R5.enchantments;
...
public class CraftEnchantment extends Enchantment implements Handleable<net.minecraft.world.item.enchantment.Enchantment> {
    ...
    public boolean isCursed() {
        return /*handle instanceof BindingCurseEnchantment || handle instanceof VanishingCurseEnchantment*/ handle.isCurse(); // Ethylene - Change for work with cursed mod enchantments
    }
