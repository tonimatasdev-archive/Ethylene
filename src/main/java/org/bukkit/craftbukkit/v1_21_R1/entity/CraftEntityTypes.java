...
public final class CraftEntityTypes {
    ...
    static {
        ...
        register(new EntityTypeData<>(EntityType.LEASH_KNOT, LeashHitch.class, CraftLeash::new, spawnData -> new net.minecraft.world.entity.decoration.LeashFenceKnotEntity(spawnData.minecraftWorld(), BlockPos.containing(spawnData.x(), spawnData.y(), spawnData.z())))); // SPIGOT-5732: LeashHitch has no direction and is always centered at a block
        ...
        register(new EntityTypeData<>(EntityType.EYE_OF_ENDER, EnderSignal.class, CraftEnderSignal::new, spawnData -> new net.minecraft.world.entity.projectile.EyeOfEnder(spawnData.minecraftWorld(), spawnData.x(), spawnData.y(), spawnData.z())));
            ...
            for (BlockFace dir : faces) {
                ...
                if (nmsBlock.isSolid() || DiodeBlock.isDiode(nmsBlock)) {
                    ...
                    AABB bb = (ItemFrame.class.isAssignableFrom(clazz))
                            ...
                            : HangingEntity.calculateBoundingBoxStatic(pos, CraftBlock.blockFaceToNotch(dir).getOpposite(), width, height);
